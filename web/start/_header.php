...
<div class="header">
    ...
    <div class="search ya-site-form ya-site-form_inited_no"
         onclick="return {'action':'http://<?= htmlspecialchars($_SERVER["HTTP_HOST"]) ?>/','arrow':false,'bg':'transparent','fontsize':12,'fg':'#000000','language':'ru','logo':'rb','publicname':'Locatus','suggest':true,'target':'_self','tld':'ru','type':3,'usebigdictionary':true,'searchid':2250973,'input_fg':'#000000','input_bg':'#ffffff','input_fontStyle':'normal','input_fontWeight':'normal','input_placeholder':'','input_placeholderColor':'#000000','input_borderColor':'#7f9db9'}">
